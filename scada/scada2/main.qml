...
ApplicationWindow {
    ...
    Room {
        ...
        EnterButton {x: -100; y: 400; onClicked: enter(roomA)}
        ExitButton  {x:   10; y: 415; onClicked: exit(roomA); rotation: 180}
    }
    ...
    Room {
        ...
        EnterButton {x: -100; y: 100; onClicked: enter(roomB)}
        ExitButton  {x:   10; y: 115; onClicked: exit(roomB); rotation: 180}
    }
    ...
    Room {
        ...
        EnterButton {x: 110; y: 280; rotation: -90; onClicked: enter(roomC)}
        ExitButton  {x: 125; y: 170; rotation:  90; onClicked: exit(roomC)}
    }
